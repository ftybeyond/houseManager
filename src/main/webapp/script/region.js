        ...
        columns:[
            ...
            {'data':'name'},
            {
                render:function(data, type, full, meta ){
                    //最后一列操作按钮渲染
                    var btnEidt = '<button type="button" onclick="selectRegionById('+full.id+')" class="btn btn-primary btn-xs">编辑</button>';
                    var btnDel = '<button type="button"  onclick="deleteRegion('+full.id+')" class="btn btn-primary btn-xs">删除</button>'
