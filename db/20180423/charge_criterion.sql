...
CREATE TABLE `charge_criterion` (
  ...
  `price_ratio` decimal(11,4) DEFAULT NULL COMMENT '价格系数，算法是按价格时应用此列',
  `area_ratio` decimal(11,4) DEFAULT NULL COMMENT '面积系数，当算法是以面积时，应用此系数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='缴费规则';
